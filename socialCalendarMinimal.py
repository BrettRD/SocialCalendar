...
class Encounter(Base):
    ...
    updater = relationship("Updater", back_populates="encounters")
...
class Updater(Base):
    ...
    encounters = relationship("Encounter", back_populates = "updater") # encounters generated by this updater
    addresses = relationship("Addresses", back_populates = "updater") # addresses managed by this updater
    
    def __repr__(self):
        return "<Updater(name ='%s')>" % (self.name)
...
class Addresses(Base):
    ...
    def __repr__(self):
        return "<Address(For ='%s', via updater ='%s', handle='%s')>" % (self.person.name, self.updater.name, self.handle)

Person.addresses = relationship("Addresses", back_populates="person")
